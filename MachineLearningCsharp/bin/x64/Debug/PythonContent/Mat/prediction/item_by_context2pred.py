...
def Get_Context():
    ...
    wd = urlopen('http://api.wunderground.com/api/7a7531c9c79ca2d3/hourly/q/FR/Bordeaux.json')# please do not excess the autorized number of loading per day
    ...
    #%%
    Item_context_pred.to_csv(paramsPath + 'Item_context_pred.csv', sep=',',index=False)# sometimes important to put encoding == to avoid issue when reading the exported file
    #%%
    #Item_context_pred= pd.read_csv("Item_context_pred.csv", sep=',')
    #print(Item_context_pred.head(5))
    #print(Item_context_pred.columns)
    #print(Item_context_pred.dtypes)
    #%%
#%%
