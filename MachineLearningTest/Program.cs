...
namespace MachineLearningTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Select product:
            Event evtProduct2Selected = new Event();
            evtProduct2Selected.Type = EventType.Product;
            evtProduct2Selected.Parameter = "20";
            pythonWrapper.AddEvent(evtProduct2Selected);

            //Select product:
            Event evtProduct3Selected = new Event();
            evtProduct3Selected.Type = EventType.Product;
            evtProduct3Selected.Parameter = "BIERES";
            pythonWrapper.AddEvent(evtProduct3Selected);
